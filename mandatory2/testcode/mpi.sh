...
mpirun -n 1 -hostfile imada-hostfile.alive mand2_mpi_opti -n 500 -no -s mpi.txt
mpirun -n 1 -hostfile imada-hostfile.alive mand2_mpi_opti -n 1000 -no -s mpi.txt
mpirun -n 1 -hostfile imada-hostfile.alive mand2_mpi_opti -n 2000 -no -s mpi.txt
mpirun -n 1 -hostfile imada-hostfile.alive mand2_mpi_opti -n 4000 -no -s openmp.txt
