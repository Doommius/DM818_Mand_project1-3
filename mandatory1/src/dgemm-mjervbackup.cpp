...
void core_4_4(double *A,double *B,double *C, unsigned int k){
    __m256d c00 = _mm_set1_pd(0.0);
    __m256d c01 = _mm_set1_pd(0.0);
    __m256d c10 = _mm_set1_pd(0.0);
    __m256d c11 = _mm_set1_pd(0.0);
    __m256d c20 = _mm_set1_pd(0.0);
    __m256d c21 = _mm_set1_pd(0.0);
    __m256d c30 = _mm_set1_pd(0.0);
    __m256d c31 = _mm_set1_pd(0.0);
    for (unsigned int k = 0; k<K; k++){
        __mm256d a
    }
}
